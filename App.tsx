    ...
    <Modal animationType="slide" transparent={false} visible={true}>
      <View style={styles.modalContainer}>
        ...
        {!isButtonHidden('description') && (
          <TouchableOpacity
            onPress={() => showSection('description')}
            style={styles.button}
          >
        ...
        {!isButtonHidden('solution') && (
          <TouchableOpacity
            onPress={() => showSection('solution')}
            style={styles.button}
          >
        ...
        {displayedSection === 'solution' && (
          <View style={styles.modalContent}>
            <Text style={styles.subtitle}>Solution:</Text>
            {disease.solution.map((item, index) => (
              <View key={`sol_${index.toString()}`}>
                <Text style={styles.subtitle}>{item.subtitle}</Text>
                <Text>{item.description}</Text>
              </View>
            ))}
        ...
        {!isButtonHidden('host') && (
          <TouchableOpacity
            onPress={() => showSection('host')}
            style={styles.button}
          >
            <Text style={styles.buttonText}>Show Host</Text>
          </TouchableOpacity>
        )}

        {displayedSection === 'host' && (
          <View style={styles.modalContent}>
        ...
        {!isButtonHidden('images') && (
          <TouchableOpacity
            onPress={() => showSection('images')}
            style={styles.button}
          >
        ...
        {displayedSection === 'images' && (
          <View style={styles.modalContent}>
            <Text style={styles.subtitle}>Images:</Text>
            {disease.images.map((item, index) => (
              <TouchableOpacity
                key={`img_${index.toString()}`}
                onPress={() => openImageModal(item.original_url)}
              >
